...
cp ./.github/secrets/match_Apple-Store-UMGC_Profile.mobileprovision ~/Library/MobileDevice/Provisioning\ Profiles/match_Apple-Store-UMGC_Profile.mobileprovision
